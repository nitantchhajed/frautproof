                                    ...
                                    transaction.map((event, key) => {
                                        ...
                                        return (
                                            <tr key={key}>
                                                ...
                                                <td>{isCompleted ? <span className='checkIcn'><AiOutlineCheck /></span> : isExpired ? "Expired" : <div className="challenge_btn_wrap"><Button type="button" className="btn challenge_btn" onClick={() => challengeTxn(id)}>Challenge</Button></div>}</td>
                                            </tr>
                                        )
                                    })
                                }
